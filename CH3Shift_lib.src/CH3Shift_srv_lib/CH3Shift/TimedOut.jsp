...
<table border="0" cellpadding="12" cellspacing="10" width="100%">
 	<tr><td bgcolor=#FFFDDA valign="top" colspan="2">
		<table>
			<tr><td colspan = "2">
				<h2><bean:message key="TimedOut.jsp.prompt.file"/></h2>
			</td></tr>
			
			<tr><td colspan = "2">
             <br/>Sorry, but you haven't used this web page for a while so the server has automatically ended <br/>
                 your session and you will have to start again.
             <br/><br/>
         	</td></tr>
